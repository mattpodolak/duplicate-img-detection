...
def test_single_upload():
  ...
  with open("./app/data/is_my_cat_normal.jpg", "rb") as f:
...
def test_multiple_uploads():
  client = TestClient(app)
  multiple_files =[('files', open('./app/data/is_my_cat_normal.jpg', 'rb')), 
    ('files', open('./app/data/is_my_cat_normal_copy.jpg', 'rb'))]
...
def test_check_duplicate():
  ...
  img = Image.open("./app/data/is_my_cat_normal.jpg")
  ...
  with open("./app/data/is_my_cat_normal_copy.jpg", "rb") as f:
    test_file ={'file':  f} 
...
def test_check_non_duplicate():
  ...
  # load image into index
  img = Image.open("./app/data/doge.png")
  img_hash = hash_image(img, hash_size)
  index.add(img_hash)
  save_index(index, hash_size=hash_size)
